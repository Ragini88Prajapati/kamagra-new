...
@section('content')
    ...
    <div id="bt_container">
        <div class="left-popup-msg">
            <div id="module_559" class="module-wrapper module-wrapper-559">
                <img src="https://www.kamagraoriginal.to/images/SIDE-bitcoin-DE.png" alt="Bitcoin payment"
                    style="width: 275px;">
            </div>
                ...
                <div id="boss-menu-category" class="box">
                    <div class="box-content">
                        <ul class="box-category boss-menu-cate new-iconarrow sidemenu-medicine"
                            style="list-style:none;padding: 5px 10px 5px 7px;border:1px solid #ddd;border-top:3px solid #0088cc;">
                            @forelse($categories as $category)
                                <li
                                    style="background:#aeddf5;padding: 5px 10px 5px 7px; font-weight:bold;color:#003e6d;font-size:16px;border-bottom:1px solid #fff;">
                                    {{ $category->name }}
                                </li>
                                @php
                                ...
                                @empty
                                    <li
                                        style="padding: 5px 10px 5px 7px; color:#666;font-style:italic;border-bottom:1px solid #eee;">
    ...
    <div class="offer-bar">
        ...
        <div class="offer-links">
            <a
                href="https://www.kamagraoriginal.to/de/produktdetails/generic-viagra-sildenafil-citrate/cobra-120-mg-daily-de">
                TAGESANGEBOT
            </a>
        ...
        <div class="menu_custom">
                            ...
                            <div class="tp-banner tp-banner0 image-banner-height">
                                <ul class="image-banner-height">
                                    ...
                                    @forelse ($banners as $item)
                                        <li class="image-banner-height" data-link="#" data-target="_self"
                                            data-transition="3dcurtain-horizontal" data-slotamount="7"
                                            data-masterspeed="500" data-saveperformance="on">
                                            <!-- MAIN IMAGE -->
                                            <img src="{{ $item->desktop_image != '' ? asset('/assets/images/banner/') . '/' . $item->desktop_image : ($item->image_name != '' ? asset('/assets/images/banner/') . '/' . $item->image_name : '') }}"
                                                alt="slidebg1"
                                                data-lazyload="{{ $item->desktop_image != '' ? asset('/assets/images/banner/') . '/' . $item->desktop_image : ($item->image_name != '' ? asset('/assets/images/banner/') . '/' . $item->image_name : '') }}"
                                            ...
                                            <div class="tp-caption big_white sft customout rs-parallaxlevel-0"
                                                data-x="342" data-y="54"
                                                ...
                                                data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 2;"><img
                                                    src="{{ asset('/assets/client2/images/') . '/dummy.png' }}"
                                                    alt=""
                                                    data-lazyload="{{ asset('/assets/client2/images/slide/') . '/line_caption.png' }}" />
                                            </div>
                                            <!-- LAYER NR. 6 -->
                                            <div class="tp-caption big_white sft customout rs-parallaxlevel-0"
                                                data-x="499" data-y="54"
                                                data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                                                data-speed="400" data-start="500" data-end="5000" data-endspeed="400"
                                                data-easing="easeOutBack" data-endeasing="easeOutBack"
                                                data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 2;">
                                                <img src="{{ asset('/assets/client2/images/') . '/dummy.png' }}"
                                                    alt=""
                                                    data-lazyload="{{ asset('/assets/client2/images/slide/') . '/line_caption.png' }}" />
                                            </div>
                                        </li>
                                ...
                                <ul class="image-banner-height">
                                    ...
                                    @forelse ($banners as $item)
                                        <li class="image-banner-height" data-link="#" data-target="_self"
                                            ...
                                            data-masterspeed="500" data-saveperformance="on">
                                            <!-- MAIN IMAGE -->
                                            <img src="{{ $item->mobile_image != '' ? asset('/assets/images/banner/') . '/' . $item->mobile_image : ($item->image_name != '' ? asset('/assets/images/banner/') . '/' . $item->image_name : '') }}"
                                                alt="slidebg1"
                                                data-lazyload="{{ $item->mobile_image != '' ? asset('/assets/images/banner/') . '/' . $item->mobile_image : ($item->image_name != '' ? asset('/assets/images/banner/') . '/' . $item->image_name : '') }}"
                                                data-bgposition="left center" data-kenburns="off" data-duration="14000"
                                                data-ease="Linear.easeNone" data-bgpositionend="right center" />
               ...
               <img src="https://www.kamagraoriginal.to/images/product/200/sildalist-120mg-blister.jpg"
                 ...
                 alt="Sildalist">
                                ...
                                <div class="deal-action">
                                    @php
                                        $dailyVariant = \App\ProductVariant::where(
                                            'product_id',
                                            $product_list[0]->id ?? 1,
                                        )
                                            ->orderBy('price', 'asc')
                                    ...
                                    @if ($dailyVariant)
                                        <button class="add-to-product-cart" data-product="{{ $dailyVariant->id }}">
            ...
            <div id="column-left" class="col-sm-3 col-md-3 col-lg-3 hidden-xs">
                ...
                <div class="login-block" style="background-color: #FFF; border: 1px solid #A0D9F7; margin: 0 0 20px; ">
                    @auth
                        <h3
                            style="margin: 0 0 10px 0; font-size: 14px; border-bottom: 2px solid #9EC8FA; background-color: #A0D9F7; line-height: 25px; padding: 5px 15px;font-weight: 700; color: #000;">
                            {{ Auth::user()->name }}</h3>
                        <div style="margin-bottom: 10px; font-size: 12px;">
                            <p style="color: #333; margin-bottom: 5px;">Welcome, {{ Auth::user()->name }}!</p>
                            <a href="{{ route('home.user-profile') }}" style="color: #006eb7; text-decoration: none;">My
                                Account</a><br>
                        ...
                        <form action="{{ route('client.authenticate') }}" method="post" style="padding: 10px;">
                            ...
                            <div style="margin-bottom: 5px; display: flex">
                                ...
                                <input type="text" name="email" required
                                    style="width: 100%; border: 1px solid #ccc; border: 1px solid #9EC8FA; width: 60%;">
                            </div>
                            <div style="margin-bottom: 10px;  display: flex">
                                <label style="font-weight: normal; font-size: 12px; color: #333; width: 35%;">Password:</label>
                                <input type="password" name="password" required
                                    style="idth: 100%; border: 1px solid #ccc;  border: 1px solid #9EC8FA;  width: 60%;">
                            </div>
                            <button type="submit"
                                style="background: #e96e00; color: white; border: 1px solid #d45500; padding: 2px 10px; font-weight: bold; font-size: 12px; border-radius: 2px; margin-left: 75px;">Log
                                in</button>
                            <div style="margin-top: 10px; font-size: 15px; font-weight: bold;">
                                <a href="{{ route('home.signup') }}" style="color: #006eb7;">Register</a><br>
                                <a href="{{ route('home.forgetPassPage') }}" style="color: #006eb7;">Forgot your
                                    password?</a>
                            </div>
                        </form>
                    @endauth
                ...
                <div class="header_category  nofloat " style="margin-bottom: 20px;">
                    <div id="boss-menu-category" class="box">
                        <div class="box-content">
                            <ul class="box-category boss-menu-cate new-iconarrow sidemenu-medicine"
                                style="list-style: none;  border: 1px solid #ddd; border-top: 3px solid #0088cc;">
                                @forelse($categories as $category)
                                    <li
                                        style="background: #aeddf5; padding: 5px 15px; font-weight: bold; color: #075BAF; font-size: 13px; border-bottom: 1px solid #fff;">
                                        {{ $category->name }}
                                    </li>
                                    @php
                                        $products = \App\Models\Client\Product::where('category_id', $category->id)
                                    ...
                                    @forelse($products as $product)
                                        <li>
                                            <a href="{{ route('client.product.product-preview', [$product->slug]) }}"
                                                style="display: block; padding: 3px 7px 3px 7px; border-bottom: 1px solid #eee; text-decoration: none; color: #003e6d; font-weight: bold; font-size: 13px;">
                ...
                <div id="module_20" class="module-wrapper-20">
                    <div class="hidden-xs">
                        <form method="get" action="{{ route('home.search') }}" class="search-form">
                            ...
                            <input type="text" id="searchInput" name="text" maxlength="100" required
                                class="module20_text" placeholder="Search products...">
                ...
                <div class="bt-product-category">
                    <div class="bt-featured-pro bt-nprolarge-tabs heightcard">
                        ...
                        <div class="multipacsmobile">
                            <h3 style="margin: 0; margin-left: -130px; font-size: 16px; font-weight: bold; color: #000;">
                                Multipacs</h3>
                        </div>
                        ...
                        <div class="row" style="margin: 0; border-left: 1px solid #eee; border-top: 1px solid #eee;">
                            @forelse ($product_list as $item)
                                @php
                                    $multiVariant = \App\ProductVariant::where('product_id', $item['id'])
                                        ->orderBy('price', 'asc')
                                        ->first();
                                @endphp
                                @if ($multiVariant)
                                            ...
                                            <div class="row product-row">
                                                ...
                                                <div class="col-xs-5 product-image-col">
                                                    <div class="product-image-wrapper">
                                                        @if (isset($item['slug']) && !empty($item['slug']))
                                                            <a
                                                                href="{{ route('client.product.product-preview', [$item['slug']]) }}">
                                                ...
                                                <div class="col-md-7 product-details">
                                                    ...
                                                    <div class="price-box">
                                                        ...
                                                        <button
                                                            class="btn btn-primary btn-sm btn-block add-to-product-cart"
...
@else
    ...
    @endif
                                    ...
                                    <div class="product-card-multipack">
                                        <div class="row product-row">
                                            ...
                                            <div class="col-xs-5 product-image-col">
                                                ...
                                                @if (isset($item['slug']) && !empty($item['slug']))
                                                    <a href="{{ route('client.product.product-preview', [$item['slug']]) }}"
                                                        class="product-moreinformation hide-mobile">
                                                        More information
                                                    </a>
                                                @else
                ...
                <div class="articles-section"
                    style="margin: 20px -15px 10px ; border: 1px solid #ddd; padding: 20px; background: #fff;">
                    ...
                    <div class="articles-preview-item">
                        <h2 class="articles-preview-title">
                            <a style=" color: #075BAF; text-decoration: none"
                                href="https://www.kamagraoriginal.to/de/artikeln/tadalafil-vs-vardenafil-517-i2267">
                        ...
                        <div class="articles-preview-preview">
                            <p>
                                Tadalafil and vardenafil are two modern, effective medications for treating erectile
                                dysfunction that achieve
                                the same result in slightly different ways. Although both belong to the category of erection
                                pills,
                                they differ in their duration and length of action. The choice between the two depends on
                    ...
                    <div class="articles-preview-item">
                        ...
                        <div class="articles-preview-preview">
                            <p>
                                Two of the most common options for treating erectile dysfunction are sildenafil and
                                vardenafil.
                                Although these substances belong to the same class of drugs, they work differently.
                                Choosing the right one can help make intimacy more relaxed, controllable, and enjoyable, so
                    ...
                    <div class="articles-preview-item">
                        ...
                        <div class="articles-preview-preview">
                            <p>
                                ...
                                including preventing severe forms of the disorder and empowering men to take immediate
                ...
                <div class="medical-disclaimer"
                    style="border: 1px solid #bcecff; background-color: white; padding: 15px; margin: 0 -15px;">
                    <h4 style="color: #31708f; font-size: 15px; font-weight: bold; margin: 0 0 5px 0;">Medical disclaimer
                    </h4>
                    <p style="font-size: 13px; color: #333; line-height: 1.4; margin: 0;">
                        You should always consult your doctor or another healthcare professional before taking any
                        medication, supplement, or treatment for a health problem, whether offered on this website or
                        elsewhere. If you have or suspect you have a medical problem, you should see your doctor
                        immediately. For all products and/or services purchased through this website, you should carefully
            ...
            $(document).on('click', '.add-to-product-cart', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        try {
                            var response_data = typeof data === 'string' ? JSON.parse(data) :
                                data;
                            ...
                            if (response_data.cart_total_quantity !== undefined) {
                                var cartText = response_data.cart_total_quantity +
                                    ' Artikel - €' + response_data.cart_total_price;
                                ...
                                var desktopCartText = response_data.cart_total_quantity + (
                                    response_data.cart_total_quantity == 1 ? ' product' :
                                    ' products') + ' - €' + response_data.cart_total_price;
                            ...
                            alert(
                                'Product added but could not update cart display. Please refresh the page.');
                            window.location.reload();
                        }
                    },
                ...
                if (searchInput) {
                    searchInput.addEventListener('input', function(e) {
                        ...
                        const productCards = document.querySelectorAll(
                            '.product-card-multipack, .product-card-bestseller');
                        ...
                        productCards.forEach(card => {
                            ...
                            if (productName.includes(searchTerm) || productSubtitle.includes(
                                    searchTerm)) {
