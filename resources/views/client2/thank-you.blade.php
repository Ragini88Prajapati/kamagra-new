...
@section('content')
    ...
    <div class="cart-container">
        ...
        <table class="payment-table">
            ...
            <tr>
                <td>
                    <img src="https://www.korig.to/app/qr/image.png?iban={{ str_replace(' ', '', $bank_details['iban'] ?? 'SK9083300000002002931879') }}&eur={{ number_format($order_data->total_amount_paid ?? 0, 2) }}+€&bname={{ urlencode($bank_details['account_name'] ?? 'LABORE s.r.o.') }}&bic={{ $bank_details['swift_bic'] ?? 'FIOZSKBAXXX' }}&logo=none&info=Order+{{ $order_id ?? ($bank_details['reference_code'] ?? 'N/A') }}"
                        alt="SEPA QR Code" class="qr">
                </td>
            </tr>
        </table>
