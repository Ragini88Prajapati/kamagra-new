                      ...
                      <tr>
                        <td width="30%" align="left">
                          <span class="basket-button1">
                            <a href="{{ route('home.index') }}" class="basketbutton1" style="text-decoration: none; display: inline-block; padding: 6px 12px;">Back to your shopping cart</a>
                          </span>
                        </td>
                        <td width="70%" align="right">
                          <span class="basket-button2">
                            <input type="submit" value="Confirm payment" class="basketbutton2" />
                          </span>
                        </td>
                      </tr>
                    </tbody>
