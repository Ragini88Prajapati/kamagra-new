...
<div class="cart-container" style="font-family: Arial, Helvetica, sans-serif;">
  ...
  <h1>Provider identification of the operator</h1>

  <p style="font-size: 13px; color: #071D35; font-family: Arial, Helvetica, sans-serif; line-height: 1.35;">&nbsp;</p>

  <p style="font-size: 13px; color: #071D35; font-family: Arial, Helvetica, sans-serif; line-height: 1.35;">
    <span style="font-size:16px;">
      SMART LOGISTIK kft. <br>
  ...
  <h2 style="color: #075BAF;">Liability for content</h2>
  <div style="font-size: 13px; color: #071D35; font-family: Arial, Helvetica, sans-serif; line-height: 1.35;">
  ...
  <h2 style="color: #075BAF;">Liability for links</h2>
  <div style="font-size: 13px; color: #071D35; font-family: Arial, Helvetica, sans-serif; line-height: 1.35;">
